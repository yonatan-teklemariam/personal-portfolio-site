...
const Navbar: React.FC = () => {
  ...
  return (
    <header className={`c-site-header fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isScrolled ? 'bg-background/80 backdrop-blur-md shadow-lg' : 'bg-transparent'}`}>
      <nav className="container mx-auto px-4 sm:px-6 lg:px-8" aria-label="Main Site Links">
